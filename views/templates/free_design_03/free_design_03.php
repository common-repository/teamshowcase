<?php
/**
 * @file free_design_03.php
 * @description Free MTT Design Three
 * 
 * */
// Security Check
if (!defined('ABSPATH'))
                    ...
                    <div style="margin-bottom:15px" class="col-md-4 col-sm-4">
                        <div class="our-team">
                            ...
                            <div class="team-prof">
                                ...
                                <span class="post">
                                    <?php if(isset($wp_team_showcase->options['general-settings']['general-mtt']['gn_mtt_job'])) echo '<i class="fa fa-briefcase"></i> '. get_post_meta($postID, 'profile_job_desc', true); if(isset($wp_team_showcase->options['general-settings']['general-mtt']['gn_mtt_company'])) echo ', '. get_post_meta($postID, 'profile_company', true);?> 
                                </span>
