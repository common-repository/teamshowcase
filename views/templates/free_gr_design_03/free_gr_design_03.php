<?php
/**
 * @file free_gr_design_03.php
 * @description Free MTT Group Design Three
 * 
 * */
// Security Check
if (!defined('ABSPATH'))
...
wp_enqueue_style('mtt-free-three-style');
                    ...
                    <div style="margin-bottom:15px" class="col-md-4 col-sm-4">
                        <div class="our-team">
                            ...
                            <div class="team-prof">
                                ...
                                <span class="post">
                                    <?php if(isset($wp_team_showcase->options['general-settings']['group-mtt']['gr_mtt_job'])) echo '<i class="fa fa-briefcase"></i> '. get_post_meta($postID, 'profile_job_desc', true); if(isset($wp_team_showcase->options['general-settings']['group-mtt']['gr_mtt_company'])) echo ', '. get_post_meta($postID, 'profile_company', true);?> 
                                </span>
